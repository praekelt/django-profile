...
class AbstractSocialProfile(models.Model):
    ...
    def facebook_url(self):
        if self.facebook_id:
            return "http://www.facebook.com/profile.php?id=%s" % \
                    self.facebook_id
        else:
            return None
...
class AbstractWebuserProfile(AbstractProfileBase, AbstractAvatarProfile, \
        AbstractContactProfile, AbstractLocationProfile, \
        AbstractPersonalProfile, AbstractSocialProfile, \
